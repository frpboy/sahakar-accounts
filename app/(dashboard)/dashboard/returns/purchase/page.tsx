...
export default function PurchaseReturnPage() {
    ...
    const { user } = useAuth();
    const isPurchase = true; // Fixed for Purchase Return
    ...
    const handleSearchBill = async () => {
        ...
        setFetching(true);
        try {
            // Purchase Return -> Look for original 'expense' (Purchase)
            ...
            // Determine supplier name from description
            setSupplierName('');
        ...
        try {
            ...
            const { data, error } = await (supabase as any)
                ...
                .insert({
                    ...
                    outlet_id: user.profile.outlet_id,
                    entry_number: `PRE-${billNumber}`, // Purchase Return ref
                    type: 'income', // Purchase Return is Income for shop (money back from supplier)
                ...
                {step === 1 && (
                    <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border dark:border-slate-800 p-8 text-center transition-all">
                        ...
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                            Find Original Purchase Bill
                        </h2>
                        <p className="text-gray-500 dark:text-slate-400 mb-8 max-w-md mx-auto">
                            Enter the Bill / Entry Number from the original purchase transaction.
                        </p>
                ...
                {step === 2 && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border dark:border-slate-800 p-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Why are we returning this product to the supplier?"
                                        rows={3}
                            ...
                            >
                                {submitting ? 'Processing Return...' : 'Confirm Purchase Return'}
                            </button>
                        </div>
                    </div>
                )}
