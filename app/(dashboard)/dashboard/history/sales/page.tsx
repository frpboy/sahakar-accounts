            ...
            <div className="p-6 space-y-6">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    <div className="relative w-full md:w-96">
                        ...
                        <input
                            type="text"
                            placeholder="Search by Sahakar ID (e.g. HP-TVL-...), ERP Bill, or Customer..."
                    ...
                    <div className="flex gap-2 w-full md:w-auto">
                        <button className="flex-1 md:flex-none flex items-center justify-center px-4 py-2 border rounded-lg bg-white text-gray-700 hover:bg-gray-50">
                        ...
                        <table className="w-full text-left">
                            <thead className="bg-gray-50 border-b">
                                <tr>
                                    ...
                                    <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase">ERP Bill</th>
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {loading ? (
                                    <tr>
                                        <td colSpan={7} className="px-6 py-12 text-center text-gray-400">Loading sales history...</td>
                                    </tr>
                                ) : filtered.length === 0 ? (
                                    <tr>
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-sm">
                                                <div className="flex gap-3">
                                                    ...
                                                    {t.daily_records?.status !== 'locked' && (
                                                        <button title="Edit" className="text-gray-400 hover:text-orange-600 transition-colors">
