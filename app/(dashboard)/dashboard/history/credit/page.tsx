...
export default function CreditHistoryPage() {
    ...
    return (
        <div className="flex flex-col h-full bg-gray-50">
            <TopBar title="Credit Received History" />
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    <div className="relative w-full md:w-96">
                        ...
                        <input
                            type="text"
                            placeholder="Search by Sahakar ID (e.g. HP-TVL-...), Receipt No, or Customer..."
                        ...
                        <table className="w-full text-left">
                            <thead className="bg-gray-50 border-b">
                                <tr>
                                    ...
                                    <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase">Receipt No</th>
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {loading ? (
                                    <tr>
                                        <td colSpan={7} className="px-6 py-12 text-center text-gray-400">Loading credit history...</td>
                                    </tr>
                                ) : filtered.length === 0 ? (
                                    <tr>
